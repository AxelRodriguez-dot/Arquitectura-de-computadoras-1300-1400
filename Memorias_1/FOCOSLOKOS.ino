...
void loop() {
  ...
  if (attempts > 0) {
    checkAttempt();  // <- CORRECCIÓN: función existente es checkAttempt()
  } else {
...
void checkAttempt() {
  ...
  switch (readButton()) {
    ...
    case 5:
      ...
      break;
    default:
      // Ningún botón fue presionado; no hacer nada
      break;
  }
  pressedButton = -1;
}
...
void reset() {
  ...
  //Show the array donde está la mina (solo para debugging)
